  ...
  return (
    <div
      onMouseMove={(e) => {
        ...
        e.currentTarget.style.transform = `perspective(900px) rotateX(${py * -6}deg) rotateY(${px * 6}deg) translateY(-4px)`;
      }}
      onMouseLeave={(e) => {
...
function ParabolaDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <path d="M 100 150 Q 200 50 300 150" stroke={accent} strokeWidth="3" fill="none" />
      <circle cx="200" cy="50" r="5" fill={accent} />
      <text x="200" y="35" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Vertex</text>
    </svg>
  );
}
...
function LineGraphDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="80" y="175" fontSize="11" fill={accent} textAnchor="middle">(1,4)</text>
      <text x="320" y="95" fontSize="11" fill={accent} textAnchor="middle">(8,1)</text>
    </svg>
  );
}
...
function LineIntersectionDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="200" y="135" fontSize="11" fill="#ef4444" fontWeight="700" textAnchor="middle">Solution</text>
    </svg>
  );
}
...
function SineWaveDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <path d="M 20 125 Q 60 75 100 125 T 180 125 T 260 125 T 340 125 T 380 125" stroke={accent} strokeWidth="3" fill="none" />
      {[20, 100, 180, 260, 340].map((x) => (
        <circle key={x} cx={x} cy="125" r="3" fill={accent} />
      ))}
      <text x="200" y="220" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">y = sin(x)</text>
    </svg>
  );
}
    ...
    <svg width="100%" height="250" viewBox="0 0 250 250">
      ...
      {[
        ...
        <g key={i}>
          ...
          <text x={p.x} y={p.y - 15} fontSize="11" fill={accent} textAnchor="middle">{p.label}</text>
        </g>
      ))}
      <text x="125" y="230" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Unit Circle</text>
    </svg>
  );
}
...
function BellCurveDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      <path d="M 50 180 Q 100 80 200 50 Q 300 80 350 180" stroke={accent} strokeWidth="3" fill="none" />
      <line x1="200" y1="50" x2="200" y2="180" stroke={accent} strokeWidth="2" strokeDasharray="5,5" />
      <text x="200" y="30" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">μ</text>
      <text x="200" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Normal Distribution</text>
    </svg>
  );
}
...
function BohrModelDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 250 250">
      ...
      <text x="125" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Bohr Model</text>
    </svg>
  );
}
...
function IonicBondDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="80" y="130" fontSize="14" fill="#fff" fontWeight="700" textAnchor="middle">Na</text>
      <circle cx="320" cy="125" r="30" fill="none" stroke={accent} strokeWidth="2" />
      <circle cx="320" cy="125" r="5" fill={accent} />
      <text x="320" y="130" fontSize="14" fill="#fff" fontWeight="700" textAnchor="middle">Cl</text>
      ...
      <text x="200" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Ionic Bond Formation</text>
    </svg>
  );
}
...
function CovalentBondDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="200" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Covalent Bond</text>
    </svg>
  );
}
...
function VSEPRDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 250 250">
      ...
      <text x="125" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Tetrahedral</text>
    </svg>
  );
}
...
function PHScaleDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="40" y="30" fontSize="11" fill={accent} fontWeight="600">Acidic</text>
      <text x="190" y="30" fontSize="11" fill={accent} fontWeight="600">Neutral (7)</text>
      <text x="340" y="30" fontSize="11" fill={accent} fontWeight="600">Basic</text>
      <text x="200" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">pH Scale (0-14)</text>
    </svg>
  );
}
...
function BenzeneDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 250 250">
      ...
      <text x="125" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Benzene (C₆H₆)</text>
    </svg>
  );
}
...
function AnimalCellDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 300 250">
      ...
      <text x="150" y="165" fontSize="10" fill={accent} textAnchor="middle">Nucleus</text>
      <ellipse cx="80" cy="80" rx="15" ry="25" fill={`${accent}30`} stroke={accent} strokeWidth="1" />
      <text x="80" y="115" fontSize="9" fill={accent} textAnchor="middle">Mito</text>
      <circle cx="220" cy="80" r="10" fill={`${accent}30`} stroke={accent} strokeWidth="1" />
      <text x="220" y="105" fontSize="9" fill={accent} textAnchor="middle">Ribo</text>
    </svg>
  );
}
...
function PlantCellDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 300 250">
      ...
      <text x="100" y="115" fontSize="9" fill={accent} textAnchor="middle">Chloro</text>
      <text x="150" y="220" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Plant Cell</text>
    </svg>
  );
}
    ...
    <svg width="100%" height="250" viewBox="0 0 400 250">
      {stages.map((stage, i) => (
        <g key={i}>
          ...
          <text x={60 + i * 90} y="160" fontSize="10" fill={accent} textAnchor="middle">{stage}</text>
        </g>
      ))}
    </svg>
  );
...
function MeiosisDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="200" y="220" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Meiosis</text>
    </svg>
  );
}
...
function DNAStructureDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 250 250">
      <path d="M 50 50 Q 80 100 50 150" stroke={accent} strokeWidth="3" fill="none" />
      <path d="M 200 50 Q 170 100 200 150" stroke={accent} strokeWidth="3" fill="none" />
      {[50, 100, 150].map((y) => (
        <line key={y} x1="50" y1={y} x2="200" y2={y} stroke={accent} strokeWidth="2" opacity="0.6" />
      ))}
      <text x="125" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">DNA Double Helix</text>
    </svg>
  );
}
...
function PhotosynthesisDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="200" y="60" fontSize="11" fill={accent} fontWeight="600">Light + CO₂ + H₂O</text>
      <line x1="250" y1="80" x2="120" y2="130" stroke={accent} strokeWidth="2" />
      <text x="200" y="210" fontSize="11" fill={accent} fontWeight="600">Glucose + O₂</text>
    </svg>
  );
}
...
function FoodChainDiagram({ accent }) {
  ...
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      {organisms.map((org, i) => (
        <g key={i}>
          <rect x={30 + i * 90} y="80" width="70" height="60" fill="none" stroke={accent} strokeWidth="2" />
          <text x={65 + i * 90} y="115" fontSize="11" fill={accent} textAnchor="middle" fontWeight="600">{org}</text>
...
function PunnettSquareDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 300 250">
      ...
      <text x="100" y="60" fontSize="12" fill={accent} textAnchor="middle" fontWeight="700">A</text>
      <text x="140" y="60" fontSize="12" fill={accent} textAnchor="middle" fontWeight="700">a</text>
      <text x="50" y="100" fontSize="12" fill={accent} textAnchor="middle" fontWeight="700">A</text>
      <text x="50" y="140" fontSize="12" fill={accent} textAnchor="middle" fontWeight="700">a</text>
      <text x="100" y="100" fontSize="11" fill={accent} textAnchor="middle">AA</text>
      <text x="140" y="100" fontSize="11" fill={accent} textAnchor="middle">Aa</text>
      <text x="100" y="140" fontSize="11" fill={accent} textAnchor="middle">Aa</text>
      <text x="140" y="140" fontSize="11" fill={accent} textAnchor="middle">aa</text>
    </svg>
  );
}
...
function MotionGraphDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <path d="M 60 180 Q 150 80 250 40 L 340 35" stroke={accent} strokeWidth="3" fill="none" />
      <text x="380" y="205" fontSize="11" fill={accent}>t</text>
      <text x="35" y="30" fontSize="11" fill={accent}>x</text>
    </svg>
  );
}
...
function ForceDiagramDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 300 250">
      ...
      <text x="165" y="65" fontSize="11" fill="#4F46E5" fontWeight="600">F↑</text>
      <line x1="170" y1="120" x2="240" y2="120" stroke="#059669" strokeWidth="3" />
      <polygon points="240,120 230,115 230,125" fill="#059669" />
      <text x="200" y="140" fontSize="11" fill="#059669" fontWeight="600">F→</text>
    </svg>
  );
}
...
function EnergyTransferDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="90" y="105" fontSize="12" fill="#4F46E5" fontWeight="600">PE</text>
      ...
      <text x="310" y="105" fontSize="12" fill="#059669" fontWeight="600">KE</text>
      <text x="200" y="200" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Energy Conservation</text>
    </svg>
  );
}
...
function WavePropagationDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="200" y="200" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Wave Motion</text>
    </svg>
  );
}
...
function ElectricFieldDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 300 250">
      ...
      <text x="150" y="105" fontSize="16" fill="#fff" fontWeight="700" textAnchor="middle">+</text>
      {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => {
        ...
        return <line key={angle} x1={x1} y1={y1} x2={x2} y2={y2} stroke={accent} strokeWidth="1" />;
      })}
      <text x="150" y="210" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Electric Field</text>
    </svg>
  );
}
...
function CircuitDiagramDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="200" y="200" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Simple Circuit</text>
    </svg>
  );
}
...
function NetworkArchitectureDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="200" y="230" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Neural Network</text>
    </svg>
  );
}
  ...
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      {["Query", "Key", "Value"].map((label, i) => (
        <g key={label}>
          <rect x={50 + i * 110} y="40" width="80" height="40" fill={`${accent}20`} stroke={accent} strokeWidth="2" />
          <text x={90 + i * 110} y="65" fontSize="11" fill={accent} textAnchor="middle" fontWeight="600">{label}</text>
        </g>
      ))}
      <text x="200" y="140" fontSize="12" fill={accent} fontWeight="600" textAnchor="middle">Similarity Computation</text>
      <rect x="150" y="170" width="100" height="40" fill={`${accent}20`} stroke={accent} strokeWidth="2" />
      <text x="200" y="195" fontSize="11" fill={accent} textAnchor="middle" fontWeight="600">Attention Output</text>
    </svg>
  );
}
...
function GradientDescentDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      <path d="M 50 80 Q 150 40 250 100 Q 300 130 350 180" stroke={accent} strokeWidth="3" fill="none" />
      ...
      <text x="200" y="230" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Gradient Descent</text>
    </svg>
  );
}
...
function GenericDiagram({ accent }) {
  return (
    <svg width="100%" height="250" viewBox="0 0 400 250">
      ...
      <text x="100" y="110" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Input</text>
      <text x="300" y="110" fontSize="12" fill={accent} textAnchor="middle" fontWeight="600">Output</text>
    </svg>
  );
}
